  ...
  return (
    <>
      ...
      <ToolbarGroup>
        <Button
          type="button"
          tooltip={isSourceCodeVisible ? "Back to editor" : "View source code"}
          onClick={onToggleSourceCode}
          aria-label={isSourceCodeVisible ? "Back to editor" : "View source code"}
          aria-pressed={isSourceCodeVisible}
        >
...
export function SimpleEditor({initialContent}: { initialContent?: string }) {
  ...
  return (
    <div className="simple-editor-wrapper">
      <EditorContext.Provider value={{ editor }}>
        ...
        >
          {mobileView === "main" ? (
            <MainToolbarContent
              ...
              onToggleSourceCode={() => setIsSourceCodeVisible((prev) => !prev)}
        ...
        {isSourceCodeVisible ? (
          <div className="simple-editor-content simple-editor-source-content">
            <pre className="simple-editor-source-code">
